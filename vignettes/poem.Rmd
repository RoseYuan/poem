...
getSpatialExternalMetrics(true=sp_toys$label, pred=sp_toys$p1,
                      ...
                      metrics=c("nsARI","SpatialAccuracy"),
...
cbind(bind_rows(list(res1.1, res2.1), .id="P"),
  ...
  pivot_longer(cols=c("nsARI", "SpatialAccuracy", "ARI"), 
...
When the evaluation is non-spatial-aware, P1 and P2 get the same ARI score. However, with spatial-aware metrics like nsARI and SpatialAccuracy, P2 gets a higher scores than P1.
